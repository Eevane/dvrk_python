...
class teleoperation:
    ...
    def __init__(self, mtml1, mtmr1, mtml2, mtmr2, psm1, psm2, clutch, coag, clutch_topic, run_period, align_mtm, operator_present_topic = ""):
    ...
    def run_following(self):
        ...
        beta2 = 0.5
        beta3 = 0.5
        puppet_measured_cf_force_1 = beta2*puppet_measured_cf_force + (1-beta2)*m2_measured_cf_force
        puppet_measured_cf_force_2 = beta3*puppet_measured_cf_force + (1-beta3)*m1_measured_cf_force
        ...
        puppet2_measured_cf_force_1 = beta2*puppet2_measured_cf_force + (1-beta2)*m4_measured_cf_force
        puppet2_measured_cf_force_2 = beta3*puppet2_measured_cf_force + (1-beta3)*m3_measured_cf_force
...
if __name__ == '__main__':
    ...
    application = teleoperation(mtm1,mtm3,mtm2,mtm4, psm1, psm2, clutch, coag, 1, 0.001,
                                True, 1)
